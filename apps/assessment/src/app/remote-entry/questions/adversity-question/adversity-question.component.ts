...
@Component({
  selector: 'app-adversity-question',
  templateUrl: './adversity-question.component.html',
  styleUrl: './adversity-question.component.scss',
})
export class AdversityQuestionComponent implements OnInit, OnDestroy {
  @Input()
  question!: AdversityQuestionDto;
  ...
  @Output()
  questionChange = new EventEmitter<AdversityQuestionDto>();
  ...
  ngOnInit() {    
    if (this.question && !(this.question.options?.length === 0)) {
      ...
      this.assessmentService
        .getAdversityQuestion(questionId)
        .subscribe((question) => {
