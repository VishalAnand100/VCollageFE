...
@Component({
  selector: 'app-psychometric-question',
  templateUrl: './psychometric-question.component.html',
  styleUrl: './psychometric-question.component.scss',
})
export class PsychometricQuestionComponent implements OnInit, OnDestroy {
  @Input()
  question!: PsychometricQuestionDto;
  ...
  ngOnInit() {
    if (this.question && !(this.question.options?.length === 0)) {
      ...
      this.assessmentService
        .getPsychometricQuestion(questionId)
        .subscribe((question) => {
